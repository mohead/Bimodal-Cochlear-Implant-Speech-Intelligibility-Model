classdef CIParameters_3
    ...
    properties
        ...
        n=[7]; % activated electrodes in one cycle. CAVE: If Channels are deactivated, n has to be adjusted: 1 electrode deactivated means n = m-1
        pps=[900*ones(1,12)]; % stimulation rate. Currently only one rate can be chosen for all electrodes
