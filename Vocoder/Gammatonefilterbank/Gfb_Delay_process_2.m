function [output, delay] = Gfb_Delay_process_2(delay, input)
...
% constant.  Finally, the complex part of this product will be returned.
%
% PARAMETERS
...
% output  A complex matrix containing the delay's output
%
% copyright: Universitaet Oldenburg
% author   : tp
% date     : Jan 2002
% complex output added: 2016, Ben Williges, adapted from Robert Benetts
% scripts for creating a frequency distortion hearing loss simulation
...
for channel = [1:number_of_channels]
  if (delay.delays_samples(channel) == 0)
    output(channel,:) = ...
        input(channel,:) * delay.phase_factors(channel);
  else
