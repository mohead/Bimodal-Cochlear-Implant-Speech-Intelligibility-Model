...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 1. handling of indput arguments, setting of general parameters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin < 5 
    help(mfilename); 
    return; 
...
%% filters, no extra spread necessary here
% Eq. 8 modified rainerb 2007-05-22
%         for i = 2:length(B)
%             Z(i) = 10 * log10(10.^(0.1 * N(i)) + sum(10.^(0.1 * (B(1:(i-1)) + 3.32 .* ...
%                 C(1:(i-1)) .* ...
%                 log10(freqb.bands(i,3) ./ ...
...
%         end;
        % all in one step
        % use tril to cancel out the low frequencies
%         Z = 10*log10(10.^(N(:)/10) ...
%                      + sum(tril(...
%                                   10.^((...
%                                       repmat(B(:).',length(E),1) ...
%                                     + 3.32*repmat(C(:).',length(E),1).*log10(freqb.bands(:,3) * (1./freqb.bands(:,2)).') ...
%                                       )/10)...
%                             ,-1),2)...
%                     );
...
switch freqb.name
    ...
    case 'gammatone'
        ...
        freqb.importance     = ...
            [
            0.0076  0.0047  0.0050  0.0000  0.0000  0.0000  0.0000  0.0000  0.0000
            0.0108  0.0120  0.0655  0.0000  0.0000  0.0000  0.0000  0.0000  0.0000
            0.0149  0.0217  0.0225  0.0000  0.0000  0.0000  0.0000  0.0000  0.0000
            0.0311  0.0263  0.0035  0.0047  0.0000  0.0000  0.0000  0.0000  0.0000
            0.0573  0.0283  0.0596  0.0120  0.0047  0.0000  0.0000  0.0000  0.0000
            0.0650  0.0304  0.0761  0.0217  0.0120  0.0047  0.0000  0.0000  0.0000
            0.0649  0.0334  0.0159  0.0263  0.0217  0.0120  0.0047  0.0000  0.0000
            0.0532  0.0377  0.0023  0.0283  0.0263  0.0217  0.0120  0.0047  0.0000
            0.0473  0.0411  0.0000  0.0304  0.0283  0.0263  0.0217  0.0120  0.0000
            0.0418  0.0440  0.0743  0.0334  0.0304  0.0283  0.0263  0.0217  0.0000
            0.0380  0.0451  0.0617  0.0377  0.0334  0.0304  0.0283  0.0263  0.0047
            0.0366  0.0419  0.0062  0.0411  0.0377  0.0334  0.0304  0.0283  0.0120
            0.0355  0.0406  0.0178  0.0440  0.0411  0.0377  0.0334  0.0304  0.0217
            0.0385  0.0438  0.0004  0.0451  0.0440  0.0411  0.0377  0.0334  0.0263
            0.0405  0.0509  0.0058  0.0419  0.0451  0.0440  0.0411  0.0377  0.0283
            0.0402  0.0562  0.0435  0.0406  0.0419  0.0451  0.0440  0.0411  0.0304
            0.0397  0.0502  0.0153  0.0438  0.0406  0.0419  0.0451  0.0440  0.0334
            0.0396  0.0488  0.0394  0.0509  0.0438  0.0406  0.0419  0.0451  0.0377
            0.0416  0.0518  0.0827  0.0562  0.0509  0.0438  0.0406  0.0419  0.0411
            0.0424  0.0513  0.0485  0.0502  0.0562  0.0509  0.0438  0.0406  0.0440
            0.0406  0.0473  0.0209  0.0488  0.0502  0.0562  0.0509  0.0438  0.0451
            0.0355  0.0434  0.0013  0.0518  0.0488  0.0502  0.0562  0.0509  0.0419
            0.0280  0.0382  0.0305  0.0513  0.0518  0.0488  0.0502  0.0562  0.0406
            0.0236  0.0320  0.0259  0.0473  0.0513  0.0518  0.0488  0.0502  0.0438
            0.0235  0.0244  0.0342  0.0434  0.0473  0.0513  0.0518  0.0488  0.0509
            0.0195  0.0208  0.0183  0.0382  0.0434  0.0473  0.0513  0.0518  0.0562
            0.0150  0.0162  0.0425  0.0320  0.0382  0.0434  0.0473  0.0513  0.0502
            0.0139  0.0108  0.0658  0.0244  0.0320  0.0382  0.0434  0.0473  0.0488
            0.0103  0.0058  0.0172  0.0208  0.0244  0.0320  0.0382  0.0434  0.0518
            0.0036  0.0010  0.0347  0.0162  0.0208  0.0244  0.0320  0.0382  0.0513
            ];
        
        
        
        if 1 == max(size(I))
             % Normalizes the band importance function to sum to 1.
            freqb.importance = freqb.importance(:,I)./sum(freqb.importance(:,I));
        else
            if 30 == length(I(:))
                 freqb.importance = I(:)/sum(I(:));
            else
